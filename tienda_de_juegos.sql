...
insert into roles(descripcion_rol,pass,correo_electronico)
values("Administrador","12345","Fabian@gmail.com");
insert into roles(descripcion_rol,pass,correo_electronico)
values("Usuario","2021","Pedro@gmail.com");

insert into juegos(nombre_juego,fecha_lanzamiento)
values("Elden Ring",2022);
insert into juegos(nombre_juego,fecha_lanzamiento)
values("Grand Theft Auto V",2013);
insert into juegos(nombre_juego,fecha_lanzamiento)
values("Hades",2018);
insert into juegos(nombre_juego,fecha_lanzamiento)
values("Doom Eternal",2020);
insert into juegos(nombre_juego,fecha_lanzamiento)
values("Death Stranding",2019);
insert into juegos(nombre_juego,fecha_lanzamiento)
values("Valorant",2020);
insert into juegos(nombre_juego,fecha_lanzamiento)
values("Hollow Knight",2017);
insert into juegos(nombre_juego,fecha_lanzamiento)
values("Team Fortress 2",2007);
insert into juegos(nombre_juego,fecha_lanzamiento)
values("Stray",2022);
insert into juegos(nombre_juego,fecha_lanzamiento)
values("Forza Horizon 5",2021);
...
select empleados.id_empleado,concat(personas.nombre1, " ", personas.nombre2, " ", personas.nombre3, " ", apellido1, " ", apellido2) as nombre_completo from empleados
inner join personas
ON empleados.persona_id = personas.id_persona;